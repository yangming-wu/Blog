...
import initPlayer from "../../../js/Home/Player/script.js"
...
<style lang="scss" scoped>
  ...
  .Player-Container{
    ...
    #player .ctrl .control .rewind {
      background-image: url(../../../img/Home/Player/rewind.png);
    }
    #player .ctrl .control .playback {
      background-image: url(../../../img/Home/Player/play.png);
    }
    #player .ctrl .control .playback.playing {
      background-image: url(../../../img/Home/Player/pause.png);
    }
    #player .ctrl .control .fastforward {
      background-image: url(../../../img/Home/Player/fastforward.png);
    }
    #player .ctrl .control .volume .mute {
      background-image: url(../../../img/Home/Player/volume.png);
    }
    #player .ctrl .control .volume .mute.enable {
      background-image: url(../../../img/Home/Player/mute.png);
    }
    ...
    #player .ctrl .progress .repeat {
      background-image: url(../../../img/Home/Player/repeat.png);
    }
    ...
    #player .ctrl .progress .shuffle {
      background-image: url(../../../img/Home/Player/shuffle.png);
    }
    ...
    #playlist li.playing {
      background: url(../../../img/Home/Player/playing.png) no-repeat 0 center;
      color: #fff;
      font-weight: bold;
    }
